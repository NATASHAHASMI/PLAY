...
class TG_CONFIG:
    ...
    bot_token = "7083181813:AAHaMMa7LE2aLjZ6hJw1S7gjYw3_bcH8Ctk"

    #DEVS or #OWNERS
    sudo_users = [5837099475, 1667104725]

    session = "conan76_web_dl_bot"

    bot_creater = "xayoonara"  # Don't Remove if you Respect the DEV

    bot_creater_id = "@xayoonara"  # Don't Remove if you Respect the DEV
